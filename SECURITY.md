...
1. **GitHub Security Advisories** — "Report a vulnerability" on the Security tab of the repository. Preferred.
2. **Email** — `keithwesleyallen@gmail.com`. PGP key on request.
