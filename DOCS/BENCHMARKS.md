...
- Daemon: `192.168.2.251:10102` (LAN, mainnet, at tip)
- Host: Windows 11, Go 1.26, local SSD
- Date: April 2026
- Command: `./hypergnomon --fastsync --daemon-rpc-address=192.168.2.251:10102 --timing --timing-every=1`
...
curl -s http://192.168.2.251:10102/json_rpc \
