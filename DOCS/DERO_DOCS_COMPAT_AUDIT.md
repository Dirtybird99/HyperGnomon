...
- Live RPC compatibility should be checked periodically against `192.168.2.251:10102`.
...
Invoke-RestMethod -Uri "http://192.168.2.251:10102/json_rpc" -Method Post -ContentType "application/json" -Body $body
```

Latest daemon probe from April 24, 2026:

- Endpoint: `192.168.2.251:10102`
- Method: `DERO.GetInfo`
